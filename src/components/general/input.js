...
export default class Input extends React.Component {
    constructor({ value, onChangeText, placeholder, password, style, icon }) {
        super({ value, onChangeText, placeholder, password, style, icon })
        this.state = {
            focus: false
        }
    }
    ...
    render() {
        ...
        return (
            <TouchableOpacity
                ...
                onPress={()=>{if(this.input){this.input.focus()}}}
            >
